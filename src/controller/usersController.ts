...
export const getUserById = async ( req:Request, res:Response ): Promise<void> => {
    ...
    try {
        const user = await prisma.findUnique({//busca unicamente el usuario por id 
            where: {
                id: userId
            }
        })
...
export const upDateUser = async ( req:Request, res:Response ): Promise<void> => {
    ...
    try {
        ...
        const user = await prisma.update({//necesita del where para saber donde actualizar y la data para saber que actulizar
            where: {
                id: userId
            },
            data: dataToUpdate
